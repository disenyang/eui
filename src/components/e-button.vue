	...
	<template>
	<button class="e-button" :style="{width:width,height:height,fontSize:fontSize,paddingLeft:paddingLeft,paddingRight:paddingRight,paddingTop:paddingTop,paddingBottom:paddingBottom,marginLeft:marginLeft,marginRight:marginRight,marginTop:marginTop,marginBottom:marginBottom,borderLeft:borderLeft,borderRight:borderRight,borderTop:borderTop,borderBottom:borderBottom,backgroundColor:backgroundColor,backgroundImage:backgroundImage,backgroundRepeat:backgroundRepeat,backgroundPosition:backgroundPosition,backgroundSize:backgroundSize,borderRadius:borderRadius,boxShadow:boxShadow,color:color}" v-on:click="click"
    :class="{solid:type=='solid',stroke:type=='stroke',text:type=='text',small:type=='small',large:size=='large',middle:size=='middle',small:size=='small'}">
    <e-icon v-if="icon" :name="icon"></e-icon>
    <span>{{label}}</span>
</button>
</template>
<script>
